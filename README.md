...
A rewrite of the `usysconf` package trigger management system from [Solus](https://getsol.us) - designed to be shared between Solus and [AerynOS](https://aerynos.com)
...
library to incorporate into [moss](https://github.com/aerynos/os-tools) - our next generation package manager.
